...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TAPU_INT = 6,                   /* TAPU_INT  */
  YYSYMBOL_TAPU_STRING = 7,                /* TAPU_STRING  */
  YYSYMBOL_EQ = 8,                         /* EQ  */
...
#line 116 "tmkoc_yacc.y"
                                         {  
                    printf("Tu abhi bhi so raha he, nahane ja nahane ja\n");
                    return 0;
                }
